...
public class VideoController {
  ...
  public HomeResponse<FindVideosResponse> findVideos(
    ...
    var response =
        new HomeResponse<>(
            homeRequest.getHeader(), new FindVideosResponse(videoService.findVideos()));
  ...
  public HomeResponse<FindFoldersResponse> findFolders(
    ...
    var response =
        new HomeResponse<>(
            homeRequest.getHeader(), new FindFoldersResponse(videoService.findFolders()));
  ...
  public HomeResponse<FindActorsResponse> findActors(
    ...
    var response =
        new HomeResponse<>(
            homeRequest.getHeader(), new FindActorsResponse(videoService.findActors()));
